%risk_train.m
%trains a neural net on the data in riskdata.txt
%Author: Antonio Peters
%Adapted from ugrad_train.m
...
plot(t11,t11)
plot(t11,a11,'*')
title(sprintf('Training: Risk Data with %g samples\n',q))
hold off
...
plot(t11,t11)
plot(t11,L1(1,:),'*')
title('linear model: Risk Data')
hold off

L21=rsq(t1,L1)
fprintf('Training: Linear fit Risk Data %g\n',L21(1))
